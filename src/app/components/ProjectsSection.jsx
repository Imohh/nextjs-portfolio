...
const projectsData = [
  ...
  },
  {
    ...
    description: "E-Commerce website for a high end luxury fashion brand based in the UK.",
    image: "/images/projects/eminence.png",
    tag: ["All", "Web"],
    gitUrl: "/",
    previewUrl: "https://eminencebygtx.com",
  },
  {
    id: 6,
    title: "Grep",
    description: "Delivery app where users can track their orders and also see details of the delivery person assigned to them.",
